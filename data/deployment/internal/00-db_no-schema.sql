...
-- Generic Object Management
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `TARGET_SCHEMA` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `TARGET_SCHEMA` ;
...
-- -----------------------------------------------------
-- Compte Utilisateur gomAdmin
-- -----------------------------------------------------
DELIMITER ;
SET SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
CREATE USER IF NOT EXISTS 'gomAdmin'@'%' IDENTIFIED BY 'admin';
GRANT ALL PRIVILEGES ON TARGET_SCHEMA.* TO 'gomAdmin'@'%';

-- -----------------------------------------------------
-- Data for table `A100_UACCT`
-- -----------------------------------------------------
START TRANSACTION;
USE `TARGET_SCHEMA`;
INSERT INTO `A100_UACCT` (`BID`, `ULOGIN`, `UHOST`) VALUES ('GOM Administrator', 'gomAdmin', '%');
INSERT INTO `A100_UACCT` (`BID`, `ULOGIN`, `UHOST`) VALUES ('DB Admin', 'root', '%');
