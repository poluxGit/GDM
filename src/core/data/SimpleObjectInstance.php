...
class SimpleObjectInstance extends Internal\GOMObject
{
  ...
  /**
   * Creation en mémoire d'une instance d'un objet (non enregistrées en base)
   *
   */
  public static function createNewSimpleObjectInstance($objDefTID)
  {
    $loObjDef = new ObjectDefinition($objDefTID);
    $loObjDef->loadObject();
    $oObjResult = new SimpleObjectInstance(NULL,$loObjDef->getFieldValueFromName('DBTable')) ;
