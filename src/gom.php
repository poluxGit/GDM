 ...
 */
 ...
 {
   $lsMessage  = "Syntaxe: php gom.php {ACTION} {ACTION_PARAMETERS}\n";
   $lsMessage .= "avec:\n";
  ...
  try{
    ...
    switch (strtoupper($lsAction)) {
      ...
      case 'LOAD_OBD':
          ...
          $loObj = GOM\Data\DataFactory::getObjectDefinition($argv[2]);
          print_r($loObj);
          break;
      case 'LOAD_MDL':
          // Chargement d'un modele
          $loObj = GOM\Data\DataFactory::getModel($argv[2]);
          print_r($loObj);
          break;
      case 'LOAD_LNKD':
          // Chargement d'une définition de lien
          $loObj = GOM\Data\DataFactory::getLinkDefinition($argv[2]);
          print_r($loObj);
          break;
      case 'LOAD_LNKMD':
          // Chargement d'une définition de metadonnées de lien
          $loObj = GOM\Data\DataFactory::getLinkMetaDefinition($argv[2]);
          print_r($loObj);
          break;
      default:
